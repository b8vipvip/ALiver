(() => {
  ...
  const assets = [
    ...
    ['link', 'aliver-douyin-live-collector-style', '/static/douyin_live_collector.css?v=0.11.0'],
    ...
    ['script', 'aliver-douyin-live-collector', '/static/douyin_live_collector.js?v=0.11.0'],
  ];
